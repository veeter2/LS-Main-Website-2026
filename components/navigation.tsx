...
const PAGE_NAMES: Record<string, string> = {
  ...
  '/briefs/financial-services':   'Financial Services Brief',
  '/briefs/legal':                'Legal Brief',
  '/briefs/energy':               'Energy & Utilities Brief',
  '/briefs/manufacturing':        'Manufacturing Brief',
  '/briefs/life-sciences':        'Life Sciences Brief',
  '/briefs/automotive':           'Automotive Brief',
  '/contact':                     'Contact',
  '/about':                       'About',
  '/about-us':                    'About',
  '/pricing':                     'Pricing',
...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href: '/briefs',
    sub: 'How sovereign intelligence deploys by vertical',
    live: true,
    Icon: MemoryArcV1,
    children: [
