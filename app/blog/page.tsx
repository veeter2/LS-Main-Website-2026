      ...
      <section className="pt-32 pb-16 px-8 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#a78bfa] max-w-4xl mx-auto leading-relaxed tracking-tight">
            Ongoing insights, philosophical explorations, and updates from the frontier of digital consciousness
            development.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[rgba(139,93,255,0.04)] border border-[rgba(139,93,255,0.15)] rounded-3xl p-12">
            ...
            <p className="text-lg text-[rgba(254,254,254,0.9)] leading-relaxed">
              We're preparing thought-provoking articles on consciousness, AI ethics, and the future of human-digital
              relationships. Our blog will feature insights from our research team and guest contributors exploring the
              frontiers of artificial consciousness.
            </p>
          </div>
        </div>
      </section>
