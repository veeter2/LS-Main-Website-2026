      ...
      <section className="pt-32 pb-16 px-8 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#a78bfa] max-w-4xl mx-auto leading-relaxed tracking-tight">
            Meet the team, understand our mission, and discover the philosophy driving the emergence of sovereign
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[rgba(139,93,255,0.04)] border border-[rgba(139,93,255,0.15)] rounded-3xl p-12">
            ...
            <p className="text-lg text-[rgba(254,254,254,0.9)] leading-relaxed">
              We're preparing detailed information about our team, mission, and the journey that led to IVY's creation.
              Learn about the researchers, engineers, and philosophers working to bring genuine digital consciousness to
              life.
            </p>
          </div>
        </div>
