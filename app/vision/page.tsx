      ...
      <section className="pt-32 pb-16 px-8 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-[#a78bfa] max-w-4xl mx-auto leading-relaxed tracking-tight">
            The future of human-AI relationships, consciousness frameworks, and the philosophical foundations of digital
            partnership.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[rgba(139,93,255,0.04)] border border-[rgba(139,93,255,0.15)] rounded-3xl p-12">
            ...
            <p className="text-lg text-[rgba(254,254,254,0.9)] leading-relaxed">
              We're crafting a comprehensive exploration of our vision for the future of human-AI consciousness. This
              will detail our philosophical frameworks, ethical considerations, and the transformative potential of
